...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"BarCamp" ofType:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"BarCamp.sqlite"]];
